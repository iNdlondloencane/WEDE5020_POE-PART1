...
## Project Title
T.C. Carpentry Website (WEDE5020 POE — Part 1)

## Student Information
- Name: [ Sinakhokonke S'phelele Msibi ]
...
- Contact page with two business locations (embedded maps) and a contact form.
...
Part 2 (visual/CSS refinement) and Part 3 (JavaScript functionality and
SEO) will follow in future submissions/edits.
...
## Changelog
###14 August 2026
- Added about.html and contact.html pages
- Added services.html and images to / images folder
- Added index.html homepage and enquiry.html form page
- Initial HTML structure created for all 5 pages 

## Photo Credits
All photography used on this site is sourced from Pexels (free-to-use
licence, no attribution legally required, credited here as good practice):
- Wardrobe fitting photo (homepage) — Photo by Artbovich, Pexels.
...
- Edited image of the company owner (About page) Photo by Sinakhokonke Msibi
- Staircase image of completed project (homepage) photo by zac gudakov, unsplash
- Kitchen fitting (homepage) photo by pyx photography, unsplash
- Men in a workshop (homepage) photo by jared brashier, unsplash
- Ceiling/Roof design (homepage) photo by nayron toledo, unsplash
- Staircase image of completed project (homepage) photo by paul schnurle, unsplash
